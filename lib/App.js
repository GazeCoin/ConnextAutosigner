  ...
  _createClass(App, [{
    ...
    value: async function autoDeposit() {
      var _state5 = this.state,
          ...
          tokenContract = _state5.tokenContract,
          connextState = _state5.connextState,
          tokenAddress = _state5.tokenAddress,
          connext = _state5.connext,
          browserMinimumBalance = _state5.browserMinimumBalance,
          ethprovider = _state5.ethprovider;
